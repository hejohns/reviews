...
\Video[]{2007}{Bryan Cantrill}{Dtrace}{https://www.youtube.com/watch?v=6chLw2aodYQ}
    A
\chapter{Dictionary}
\Dict[tags={terminology},date=2022-12-21]{AFAI*}
...
\Dict[tags={terminology},date=2022-12-21]{TFAE}
...
\Dict[tags={order},date=2022-12-21]{Thin Yoneda Embedding}
    \begin{thm}[see Stoy,\textit{Denotational Semantics} 6.29. Theorem.]
        ...
        \marginnote{The partial order is often a lattice already.
        I suppose you'd have to ensure the embedding respects the lattice structure as well,
        but afaict this should happen.
        Similar situation w/ the Yoneda embedding.}
    \end{thm}
    \begin{proof}
        alt.
        \begin{itemize}
    ...
    \footnotetext{actually $\mathbb{Q}$ is a total non-empty order, thus a lattice,
